...
For the full list of settings and their values, wee
https://docs.djangoproject.com/5.1/ref/settings/
"""
import os
...
KAKAO= {
    ...
    'REDIRECT_URI': os.getenv('KAKAO_REDIRECT_ID'),
...
AUTH_PASSWORD_VALIDATORS= [
    {
        "NAME": "django.contrib.auth.password_validation.UserAttrbutesSimilarityValidator",
    },
    {
