...
urlpatterns = [
    ...
    path('get-account-id', 
         AccountView.as_view({'post': 'getAccountId'}), 
         name='get-account-id'
     ),
    ...
    path('email', 
         AccountView.as_view({'post': 'getEmail'}), 
         name='email-account'
     ),
    path('withdraw', 
         AccountView.as_view({'post': 'withdrawAccount'}), 
         name='withdraw-account'
     ),
    path('gender', 
         AccountView.as_view({'post': 'getGender'}), 
         name='gender-account'
     ),
    path('birthyear', 
         AccountView.as_view({'post': 'getBirthyear'}), 
         name='birthyear-account'
     ),
    path('account-check', 
         AccountView.as_view({'post': 'checkPassword'}), 
         name='normal-login-check-account'
     ),
    ...
    path('role-type',
         ...
         name='account-role-type'
     ),
    path('profile',
         AccountView.as_view({'post':'getProfile'}),
